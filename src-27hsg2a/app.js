...
bts.factory('Common', ['$location', '$http', 'ConfigSvc', function ($location, $http, ConfigSvc) {
  ...
  var isMobileCheck = function () {
    ...
    Logger.debug('bts.Common.isMobileCheck: ' + check + ' ' + navigator.userAgent);
    return check;
  }
  var isIPad = function  () {
    var retVal = false;
    (function(a,b){if(/iPad/i.test(a))retVal = true})(navigator.userAgent||navigator.vendor);
    Logger.debug('bts.Common.isIPad: ' + retVal + ' ' + navigator.userAgent);
    return retVal;
  };
